...
import com.liuyi.httplibrary.exception.ApiException;
import com.liuyi.httplibrary.exception.ExceptionEngine;
import com.liuyi.httplibrary.retrofit.HttpRequestListener;
import com.liuyi.httplibrary.retrofit.RxActionManagerImpl;
    ...
    public void onNext(@NonNull T t) {
        ...
        try {
            if (t != null) {
                ...
                onError(new ApiException(new NullPointerException(), ExceptionEngine.ANALYTIC_SERVER_DATA_ERROR));
            }
        } catch (Exception e) {
